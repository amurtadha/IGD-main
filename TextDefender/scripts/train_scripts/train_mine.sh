...
#SBATCH --job-name=train_agnews_ascc_albert
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
python main.py\
  ...
  --model_type=bert \
  --ddp-backend=no_c10d\
  --model_name_or_path=/workspace/plm/bert/\
  --dataset_name=$dn \
  --training_type=$tt \
  --do_lower_case=True

#  --dataset_path=/root/TextDefender/dataset/agnews
#
...
#     python main.py --mode=train --model_type=albert --model_name_or_path=/root/manifold_defense/models/albert-base-v2 --dataset_name=agnews --dataset_path=/root/TextDefender/dataset/agnews --training_type=ascc --max_seq_len=128 --do_lower_case=True
#     "
