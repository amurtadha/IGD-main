...
python main.py --mode=attack --model_type=bert --model_name_or_path=/workspace/June/ADS/Finale_code/baselines/tmd-main/models/bert-base-uncased-yelp_polarity --dataset_name=yelppolarity --dataset_path=/workspace/June/ADS/Finale_code/baselines/tmd-main/yelppolarity/processed/ --training_type=safer --max_seq_len=256 --do_lower_case=True --attack_method=pwws --method=3 --start_index=0 --end_index=334
