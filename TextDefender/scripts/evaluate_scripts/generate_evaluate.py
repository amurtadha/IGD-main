...
if __name__ == "__main__":
    ...
    parser.add_argument("--template_path", type=str, default="/root/TextDefender/scripts/template_sbatch.txt")
    parser.add_argument("--top_10_path", type=str, default="/root/TextDefender/scripts/top_10_candidates.txt")
    parser.add_argument("--output_dir", type=str, default="/root/TextDefender/scripts/evaluate_scripts")
