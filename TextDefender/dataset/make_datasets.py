...
def main(args):
    if args.dataset == "sst2":
        dataset = load_dataset("glue", args.dataset, cache_dir='/workspace/datasets/')
        dataset = dataset.rename_column("sentence", "text")
    else:
        dataset = load_dataset(args.dataset, cache_dir='/workspace/datasets/')
    ...
    if args.dataset in ["imdb", 'ag_news',"snli", "yelp_polarity"]:
