...
class ProgramArgs(argparse.Namespace):
    def __init__(self):
        ...
        self.model_name_or_path = '/workspace/plm/{}'.format(self.model_type)
        ...
        # path parameters
        self.workspace = '/workspace/IGD/submission_to_github/TextDefender/'
        self.states = self.workspace.replace('TextDefender', 'state_dict')
        ...
        self.sentiment_path = self.workspace.replace('TextDefender/', '') + '/datasets/sentiment_word/sentiment-words.txt'
        ...
        self.n_candidates=1
        self.m=0.3
        self.inactivate_data_loss=0
        self.inactivate_lm_loss=0
        ...
        self.nbr_file = self.workspace.replace('TextDefender/', '') + 'datasets/counter/counterfitted_neighbors.json'
        ...
        # scripts args
        self.gm = "infogan"
        self.gm_path = self.workspace + "outputs/infogan_bert_agnews/uncategorized/2ypnerq8/checkpoints/epoch=99-step=10599.ckpt"
    ...
    def build_caching_dir(self):
        ...
        if self.safer_perturbation_set is not None:
            ...
            self.safer_perturbation_set = os.path.join('/workspace/June/ADS/datasets/embedding/{}_{}'.format(self.dataset_name.lower(),self.safer_perturbation_set))
